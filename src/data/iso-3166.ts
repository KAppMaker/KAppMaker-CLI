// ISO 3166-1 alpha-2 → alpha-3 mapping. Used to translate Play region codes
// (alpha-2, e.g. "US") to ASC territory codes (alpha-3, e.g. "USA") and back.
// Covers all ~250 ISO 3166-1 entries plus a few non-standard codes used by
// Apple / Google (e.g. "XK" / "XKS" for Kosovo).
...
export const ALPHA2_TO_ALPHA3: Record<string, string> = {
  ...
  WF: 'WLF', WS: 'WSM',
  // Kosovo: ISO uses XK; ASC uses XKS.
  XK: 'XKS',
