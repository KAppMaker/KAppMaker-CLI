---
name: kappmaker-store-listing
description: Create and manage app store listings — App Store Connect setup and Google Play Console management (listings, data safety, releases, subscriptions). Use when the user asks to set up App Store Connect, configure Google Play Console, or create and update a store listing.
---

# KAppMaker — Store Listing
